...
import hotelservicessv.accesoadatos.RolDAL;
import hotelservicessv.accesoadatos.AdministradorDAL;
import hotelservicessv.appweb.utils.*;
import hotelservicessv.entidadesdenegocio.Rol;
import hotelservicessv.entidadesdenegocio.Administrador;
    ...
    private void doPostRequestLogin(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (administrador_auth.getId() != 0 && administrador_auth.getLogin().equals(administrador.getLogin())) {
                ...
                SessionUser.autenticarUser(request, administrador_auth);
