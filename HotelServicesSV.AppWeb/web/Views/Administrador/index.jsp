                                ...
                                <tr data-page="<%= tempNumPage%>">                                    
                                    ...
                                    <td>
                                        <div style="display:flex">
                                             <a href="Administrador?accion=edit&id=<%=administrador.getId()%>" title="Modificar" class="waves-effect waves-light btn green">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a href="Administrador?accion=details&id=<%=administrador.getId()%>" title="Ver" class="waves-effect waves-light btn blue">
                                            <i class="material-icons">description</i>
                                        </a>
                                        <a href="Administrador?accion=delete&id=<%=administrador.getId()%>" title="Eliminar" class="waves-effect waves-light btn red">
